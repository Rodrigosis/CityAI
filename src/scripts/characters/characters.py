from scripts.characteristics_and_skills import CoreCharacteristics, LewdCharacteristics, SexInterest, \
    SexSkills, Skills, Body, SchoolPerformance, CharacterStatus, CharacterTraits
